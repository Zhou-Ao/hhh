# -*- coding: utf-8 -*-
"""
Created on Mon Feb 20 14:09:14 2017
...
#------------------------------------------------------------------------------
store = pd.HDFStore('WeeklySignal20170224.h5') # modify the store file name accordingly
...
if len(final_df) > 0:
    ...
    final_df.to_csv('./Signals/WeeklySignal' + datetime.date.today().strftime('%Y%m%d') + '.csv')
